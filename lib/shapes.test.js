...
describe('Shapes', () => {
    ...
    describe('Square', () => {
        it('should return a blue square with white text reading SVG', () => {
            ...
            shape.setText('SVG');
            shape.setTextColor('white');
            expect(shape.render()).toEqual(`<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="300" height="200"> <rect x="0" y="0" width="300" height="200" fill="blue" /> <text x="150" y="125" fill="white" font-size="60" text-anchor="middle">SVG</text> </svg>`);
        })
    })
})
