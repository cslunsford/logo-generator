...
describe('Shapes', () => {
    describe('Triangle', () => {
        it('should return a blue triangle with white text reading SVG', () => {
            ...
            expect(shape.render()).toEqual(`<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="300" height="200"> <polygon points="150, 18 244, 182 56, 182" fill="blue" /> <text x="153" y="135" fill="white" font-size="60" text-anchor="middle">SVG</text> </svg>`);
        })
    })
    describe('Circle', () => {
